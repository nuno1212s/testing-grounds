...
pub async fn setup_client(
    ...
    client::bootstrap_client::<ReconfProtocol, MicrobenchmarkData, ClientNode, OrderProtocol>(
        id, conf,
    )
    .await
}
...
pub async fn setup_replica(
    ...
    let op_config = PBFTConfig::new(timeout_duration.clone(), watermark, proposer_config);
    ...
    let vt_config = ViewTransferConfig { timeout_duration };
